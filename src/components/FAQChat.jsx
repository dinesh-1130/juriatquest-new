...
export default function PremiumFAQChatBot() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {open && (
        <div className="fixed bottom-6 right-6 w-96 max-h-[75vh]  backdrop-blur-xl shadow-2xl  rounded-xl flex flex-col overflow-hidden text-sm z-50 animate-in slide-in-from-bottom-5 duration-300">
          {/* Header */}
